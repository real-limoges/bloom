...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1830: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_2522: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1846: (a: number, b: number, c: number) => void;
