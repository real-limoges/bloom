...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1771: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_2463: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1787: (a: number, b: number, c: number) => void;
